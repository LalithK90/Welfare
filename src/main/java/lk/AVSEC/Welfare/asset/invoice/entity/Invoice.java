...
public class Invoice extends AuditEntity {
    ...
    private lk.AVSEC.Welfare.asset.invoice.entity.Enum.InvoicePrintOrNot invoicePrintOrNot;

    @Enumerated(EnumType.STRING)
    private PaymentMethod paymentMethod;

    @Enumerated(EnumType.STRING)
    private lk.AVSEC.Welfare.asset.invoice.entity.Enum.InvoiceValidOrNot invoiceValidOrNot;
    ...
    private List<lk.AVSEC.Welfare.asset.invoice.entity.InvoiceItem> invoiceItemQuantities;
