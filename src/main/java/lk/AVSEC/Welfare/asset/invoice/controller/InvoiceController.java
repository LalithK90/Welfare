...
import lk.AVSEC.Welfare.asset.discountRatio.service.DiscountRatioService;
...
public class InvoiceController {
    private final lk.AVSEC.Welfare.asset.invoice.service.InvoiceService invoiceService;
    private final lk.AVSEC.Welfare.asset.item.service.ItemService itemService;
    ...
    public InvoiceController(lk.AVSEC.Welfare.asset.invoice.service.InvoiceService invoiceService, lk.AVSEC.Welfare.asset.item.service.ItemService itemService, CustomerService customerService,
                             lk.AVSEC.Welfare.asset.ledger.service.LedgerService ledgerService, DateTimeAgeService dateTimeAgeService,
    ...
    private String common(Model model, Invoice invoice) {
        ...
        model.addAttribute("invoicePrintOrNots", lk.AVSEC.Welfare.asset.invoice.entity.Enum.InvoicePrintOrNot.values());
    ...
    public String persistInvoice(@Valid @ModelAttribute Invoice invoice, BindingResult bindingResult, Model model) {
        ...
        invoice.setInvoiceValidOrNot(lk.AVSEC.Welfare.asset.invoice.entity.Enum.InvoiceValidOrNot.VALID);
    ...
    public String removeInvoice(@PathVariable( "id" ) Integer id) {
        ...
        invoice.setInvoiceValidOrNot(lk.AVSEC.Welfare.asset.invoice.entity.Enum.InvoiceValidOrNot.NOTVALID);
