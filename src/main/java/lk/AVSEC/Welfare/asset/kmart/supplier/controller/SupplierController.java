package lk.AVSEC.Welfare.asset.kmart.supplier.controller;
    ...
    public String persist(@Valid @ModelAttribute Supplier supplier, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if (supplier.getId() == null) {
            ...
            if (supplierService.lastSupplier() == null) {
                ...
                supplier.setCode("AVSEC"+makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                String previousCode = supplierService.lastSupplier().getCode().substring(5);
                supplier.setCode("AVSEC"+makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
