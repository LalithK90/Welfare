package lk.AVSEC.Welfare.asset.goodReceivedNote.service;


import lk.AVSEC.Welfare.asset.goodReceivedNote.dao.GoodReceivedNoteDao;
...
public class GoodReceivedNoteService implements AbstractService<GoodReceivedNote, Integer> {
    ...
    public GoodReceivedNote findByPurchaseOrder(lk.AVSEC.Welfare.asset.PurchaseOrder.entity.PurchaseOrder purchaseOrder) {
