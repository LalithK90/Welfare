package lk.AVSEC.Welfare.asset.item.service;


import lk.AVSEC.Welfare.asset.category.entity.Category;
import lk.AVSEC.Welfare.asset.item.dao.ItemDao;
...
public class ItemService implements AbstractService<Item, Integer> {
    ...
    private final lk.AVSEC.Welfare.asset.ledger.dao.LedgerDao ledgerDao;

    @Autowired
    public ItemService(ItemDao itemDao, lk.AVSEC.Welfare.asset.ledger.dao.LedgerDao ledgerDao) {
