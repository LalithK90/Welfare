package lk.AVSEC.Welfare.asset.a_shop_management.goodReceivedNote.controller;
...
public class GoodReceivedNoteController {
    ...
    public GoodReceivedNoteController(GoodReceivedNoteService goodReceivedNoteService,
                                      lk.AVSEC.Welfare.asset.a_shop_management.PurchaseOrder.service.PurchaseOrderService purchaseOrderService, lk.AVSEC.Welfare.asset.a_shop_management.ledger.service.LedgerService ledgerService) {
    ...
    public String notCompleteAll(Model model) {
        model.addAttribute("notCompleteAll",
                           purchaseOrderService.findByPurchaseOrderStatus(lk.AVSEC.Welfare.asset.a_shop_management.PurchaseOrder.entity.Enum.PurchaseOrderStatus.NOT_COMPLETED));
...
//New Leger add to add system as new item on ledger
        List<lk.AVSEC.Welfare.asset.a_shop_management.ledger.entity.Ledger> ledgers = new ArrayList<>();
        for ( lk.AVSEC.Welfare.asset.a_shop_management.ledger.entity.Ledger ledger : goodReceivedNote.getLedgers() ) {
            lk.AVSEC.Welfare.asset.a_shop_management.ledger.entity.Ledger ledgerDB = ledgerService.findByItemAndAndExpiredDateAndSellPrice(ledger.getItem(),
...
//if there is on value in ledger need to update it
        ...
        lk.AVSEC.Welfare.asset.a_shop_management.PurchaseOrder.entity.PurchaseOrder purchaseOrder = purchaseOrderService.findById(goodReceivedNote.getPurchaseOrder().getId());
        purchaseOrder.setPurchaseOrderStatus(lk.AVSEC.Welfare.asset.a_shop_management.PurchaseOrder.entity.Enum.PurchaseOrderStatus.NOT_PROCEED);
