package lk.AVSEC.Welfare.asset.a_shop_management.item.service;


import lk.AVSEC.Welfare.asset.a_shop_management.category.entity.Category;
import lk.AVSEC.Welfare.asset.a_shop_management.item.dao.ItemDao;
...
public class ItemService implements AbstractService<Item, Integer> {
    ...
    private final lk.AVSEC.Welfare.asset.a_shop_management.ledger.dao.LedgerDao ledgerDao;

    @Autowired
    public ItemService(ItemDao itemDao, lk.AVSEC.Welfare.asset.a_shop_management.ledger.dao.LedgerDao ledgerDao) {
