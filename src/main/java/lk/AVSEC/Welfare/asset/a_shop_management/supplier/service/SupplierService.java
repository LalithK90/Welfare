package lk.AVSEC.Welfare.asset.a_shop_management.supplier.service;
...
public class SupplierService implements AbstractService<Supplier, Integer> {
    private final lk.AVSEC.Welfare.asset.a_shop_management.supplier.dao.SupplierDao supplierDao;

    @Autowired
    public SupplierService(lk.AVSEC.Welfare.asset.a_shop_management.supplier.dao.SupplierDao supplierDao) {
    ...
    public Supplier persist(Supplier supplier) {
        if (supplier.getId() == null) {
            supplier.setItemSupplierStatus(lk.AVSEC.Welfare.asset.a_shop_management.supplierItem.entity.Enum.ItemSupplierStatus.CURRENTLY_BUYING);
        }
    ...
    public Supplier findByIdAndItemSupplierStatus(Integer supplierId, lk.AVSEC.Welfare.asset.a_shop_management.supplierItem.entity.Enum.ItemSupplierStatus itemSupplierStatus) {
