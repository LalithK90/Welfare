package lk.AVSEC.Welfare.asset.a_shop_management.goodReceivedNote.service;


import lk.AVSEC.Welfare.asset.a_shop_management.goodReceivedNote.dao.GoodReceivedNoteDao;
...
public class GoodReceivedNoteService implements AbstractService<GoodReceivedNote, Integer> {
    ...
    public GoodReceivedNote findByPurchaseOrder(lk.AVSEC.Welfare.asset.a_shop_management.PurchaseOrder.entity.PurchaseOrder purchaseOrder) {
