package lk.AVSEC.Welfare.asset.payment.service;

import lk.AVSEC.Welfare.asset.payment.dao.PaymentDao;
...
public class PaymentService implements AbstractService<Payment, Integer > {
    ...
    public List< Payment > findByPurchaseOrder(lk.AVSEC.Welfare.asset.PurchaseOrder.entity.PurchaseOrder purchaseOrder) {
